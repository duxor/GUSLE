...
return [
    ...
    */
    ...
    "required_with_all" => "Поље :attribute је побавезно када је :values приказано.",
    "required_without" => "Пољеe :attribute је потребно када поље :values није присутан.",
    "required_without_all" => "Поље :attribute је потребно када ниједан од следећих поља :values нису присутни.",
    ...
    "size"             => [
        ...
        "array"   => "Поље :attribute мора садржатиi :size ставки.",
    ],
    ...
    */
    'custom' => [
        ...
        'vrsta_objave_id' => [
            'required'=>'Врста догађаја је обавезно поље.'
        ],
        'slug' => [
            'required'=>'Морате креирати слуг кликом на дугме слуг.'
        ],
    ],
    /*
    |--------------------------------------------------------------------------
